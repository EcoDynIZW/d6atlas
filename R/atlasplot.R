...
atlasplot <- function(color_intensity = 1,
  ...
  g <- ggplot2::ggplot() +
    ## agriculture_09 .............................................................
    ggplot2::geom_sf(data = agriculture_09,
                     fill = col_agriculture,
                     color = col_agriculture,
                     lwd = 0.05,
                     alpha=1)+
    ## water_01 .............................................................
    ggplot2::geom_sf(data = water_01,
                     fill = col_water,
                     color = col_water,
                     lwd = 0.05)+
    ## water_02 .............................................................
    ggplot2::geom_sf(data = water_02,
                     fill = col_water,
                     color = col_water,
                     lwd = 0.05)+
    ## ruderal_03 .............................................................
    ggplot2::geom_sf(data = ruderal_03,
                     fill = col_ruderal,
                     color = col_ruderal,
                     lwd = 0.05)+
    ## swamp_04 .............................................................
    ggplot2::geom_sf(data = swamp_04,
                     fill = col_ruderal,
                     color = col_ruderal,
                     lwd = 0.05)+
    ## grassland_05 .............................................................
    ggplot2::geom_sf(data = grassland_05,
                     fill = col_grassland,
                     color = col_grassland,
                     lwd = 0.05)+
    ## bushland_07 .............................................................
    ggplot2::geom_sf(data = bushland_07,
                     fill = col_forest,
                     color = col_forest,
                     lwd = 0.05)+
    ## forest_08 .............................................................
    ggplot2::geom_sf(data = forest_08,
                     fill = col_forest,
                     color = col_forest,
                     lwd = 0.05)+
    ## garden_graveyard_10 .............................................................
    ggplot2::geom_sf(data = garden_graveyard_10,
                     fill = col_grassland,
                     color = col_grassland,
                     lwd = 0.05)+
    ## built_up_12 .............................................................
    ggplot2::geom_sf(data = built_up_12,
                     fill = "#948f8d",
                     color = "#948f8d",
                     lwd = 0.05)+
    ggplot2::theme_void()
